...
@Component({
  selector: 'app-coa-recording',
  templateUrl: './coa-recording.component.html',
  styleUrls: ['./coa-recording.component.scss']
})
export class CoaRecordingComponent implements OnInit {
recordings: any = [];
  ...
  getRecordings(page?: PageEvent): void {
    ...
    if(this.search && this.search.search ){
      ...
      url = `recordings/allcoarecordings/${this.pageSize}?page=${this.pageIndex}`;
