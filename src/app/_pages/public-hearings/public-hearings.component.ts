...
@Component({
  selector: 'app-public-hearings',
  templateUrl: './public-hearings.component.html',
  styleUrls: ['./public-hearings.component.scss']
})
export class PublicHearingsComponent implements OnInit {
recordings: any = [];
  ...
  getRecordings(page?: PageEvent): void {
    ...
    if(this.search && this.search.search ){
      ...
      url = `recordings/allpublichearings/${this.pageSize}?page=${this.pageIndex}`;
